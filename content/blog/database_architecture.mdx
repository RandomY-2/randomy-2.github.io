...
from DuckDB paper so you can follow every phase directly in your editor.
...
As shown above, thee entry point for DuckDB parsing logic is `ClientContext::ParseStatements`
...
In DuckDB, the *binder* and the *logical plan generator* operate almost back-to-back. Once binding
finishes, a logical plan is already created. The DuckDB demo paper describes it as:
