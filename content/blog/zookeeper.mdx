...
title: "ZooKeeper: Coordination Kernel for Internet-scale Systems"
date: "2026-01-13"
...
- **Single System Image**
  A client will see the same view of the service regardless of the server that it connects to (but read can be stale).
